...
<!--
Thank you for your effort to report a bug in the Cata-Log project!

The time to maintain and advance this project is precious,
so we need to focus and filter what time is spent on.

- If your issue is a how-to question, please try to get an answer elsewhere,
  e.g. stackoverflow, reddit or the documentation.

- Please do make sure to check that the problem is not related to your particular setup.
  If the issue lies with your hardware or specific system configuration,
  it is unlikely that we will be able to help.

- If the bug is security related, please do not file a public issue
  but contact one of the maintainers privately!
...
<!--
Summarize the bug and how you discovered it.
This gives us a first idea of what may be going on.
-->
...
<!--
Put screenshots documenting the bug in action here.
This is especially helpful if the bug is related to the webinterface.
-->
...
<!--
Are you interested in fixing this problem yourself?
